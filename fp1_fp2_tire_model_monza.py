...
def build_tire_model_from_practice(compound_data, compound_name, base_pace=81.5):
    """
...
def build_compound_models_from_practice(year, gp_name, base_pace=81.5):
    """
...
def get_tire_performance_from_practice_models(compound, lap_in_stint, compound_models, 
                                            base_pace=81.5, weather='dry', track_evolution=0,
